...
public class ProjectDetails {
    ...
    static LocalDate completionDate;

    // Methods
    public ProjectDetails(int projectNum, String projectName, String buildingType, String address,
    int ERFNum, double feesCost, double feesPaid, String deadline, String status, LocalDate completionDate) {
        ...
        ProjectDetails.completionDate = completionDate;
    }
